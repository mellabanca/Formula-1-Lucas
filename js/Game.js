class Game {
  ...
  handlePlayerControls() {
    ...
    if (keyIsDown(LEFT_ARROW) || keyIsDown("a") && player.positionX > width / 3 - 50) {
      this.indopraesquerda = true;
      player.positionX -= 5;
      player.update();
    }

    if (keyIsDown(RIGHT_ARROW) || keyIsDown("d") && player.positionX < width / 2 + 300) {
      this.indopraesquerda = false;
      player.positionX += 5;
      player.update();
    }
